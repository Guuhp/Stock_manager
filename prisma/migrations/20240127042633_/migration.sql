/*
  ...
  - You are about to drop the `associate_user_wharehouse` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "associate_user_wharehouse" DROP CONSTRAINT "associate_user_wharehouse_userId_fkey";

-- DropForeignKey
ALTER TABLE "associate_user_wharehouse" DROP CONSTRAINT "associate_user_wharehouse_warehouseId_fkey";

-- DropTable
DROP TABLE "associate_user_wharehouse";
